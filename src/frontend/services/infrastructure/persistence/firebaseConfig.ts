...
function readEnv(key: (typeof REQUIRED_ENV_KEYS)[number]): string {
  ...
  // O Vite faz a substituição destas variáveis de forma estática em tempo de build.
  // Por isso, propriedades dinâmicas como import.meta.env[key] retornam undefined.
  const viteEnvMap: Record<string, string | undefined> = {
