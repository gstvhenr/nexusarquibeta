...
7. Run CI gate before final handoff.
8. If an error was fixed after gate failure, register it in `.agent/lessons-learned.md`.
9. If the same pattern appears 3+ times, promote it to `.agent/rules/nexusarqui.md`.
10. Update docs/ADR if structural.
